...
# Documentation
* [GoDoc documentation for go-sdl2](https://godoc.org/github.com/gonutz/go-sdl2)
...
For more complete examples, see https://github.com/gonutz/go-sdl2-examples. You can run any of the `.go` files with `go run`.
...
4. Open up a terminal such as `Git Bash` and run `go get -v github.com/gonutz/go-sdl2/sdl`.
5. (Optional) You can repeat __Step 2__ for [SDL_image](https://www.libsdl.org/projects/SDL_image), [SDL_mixer](https://www.libsdl.org/projects/SDL_mixer), [SDL_ttf](https://www.libsdl.org/projects/SDL_ttf)
    * NOTE: pre-build the libraries for faster compilation by running `go install github.com/gonutz/go-sdl2/{sdl,img,mix,ttf}`
...
`go get -v github.com/gonutz/go-sdl2/sdl`\
`go get -v github.com/gonutz/go-sdl2/img`\
`go get -v github.com/gonutz/go-sdl2/mix`\
`go get -v github.com/gonutz/go-sdl2/ttf`\
`go get -v github.com/gonutz/go-sdl2/gfx`

or type this if you use Bash terminal:\
`go get -v github.com/gonutz/go-sdl2/{sdl,img,mix,ttf}`
...
For the list of OS and architecture, you can see inside the [.go-sdl2-libs](https://github.com/gonutz/go-sdl2/tree/master/.go-sdl2-libs) directory.

NOTE: If you're using the new Go Module system, you will need to refer to the master branch for now by running:

`go get -v github.com/gonutz/go-sdl2/sdl@master`
...
UPDATE: Recent update added a call queue system where you can put thread-sensitive code and have it called synchronously on the same OS thread. See the `render_queue` or `render_goroutines` examples from https://github.com/gonutz/go-sdl2-examples to see how it works.
...
On __Other Operating Systems__, you will need to compile smpeg and SDL_mixer from source with the MP3 option enabled. You can find smpeg in the `external` directory of SDL_mixer. Refer to issue [#148](https://github.com/gonutz/go-sdl2/issues/148) for instructions.
...
For Android, see https://github.com/gonutz/go-sdl2-examples/tree/master/examples/android.
